...
namespace SIPSorcery.SoftPhone
{
    public class SIPClient
    {
        ...
        private string m_sipProxyServer = SIPSoftPhoneState.SIPProxyServer;
        private string m_sipProxyServerPort = SIPSoftPhoneState.SIPProxyServerPort;
        ...
        public SIPClient(SIPTransport sipTransport)
        {
            ...
            SIPEndPoint proxyEndpoint = null;
            if(m_sipProxyServer != null)
            {
                proxyEndpoint = SIPEndPoint.ParseSIPEndPoint($"udp:{Dns.GetHostAddresses(m_sipProxyServer)[0]}{ (string.IsNullOrEmpty(m_sipProxyServerPort) ? "" : ":"+m_sipProxyServerPort)  }");
            }

            m_userAgent = new SIPUserAgent(m_sipTransport, proxyEndpoint);
