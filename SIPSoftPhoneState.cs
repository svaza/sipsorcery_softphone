...
namespace SIPSorcery.SoftPhone
{
    public class SIPSoftPhoneState : IConfigurationSectionHandler
    {
        ...
        public static readonly string SIPProxyServer = ConfigurationManager.AppSettings["SIPProxyServer"];        // Get the SIP server from the config file.
        public static readonly string SIPProxyServerPort = ConfigurationManager.AppSettings["SIPProxyServerPort"];        // Get the SIP server from the config file.
        public static readonly string OutputRecordingFolder = ConfigurationManager.AppSettings["OutputRecordingFolder"];        // Get the SIP server from the config file.
